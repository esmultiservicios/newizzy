<?php
// ajax/addPagoComprasTransferenciaAjax.php
$peticionAjax = true;
...
if (strtolower(obtenerPostPagoCompra('bk_nm')) === 'undefined' || strtolower(obtenerPostPagoCompra('bk_nm')) === 'null') {
    responderErrorPagoCompra('Debe seleccionar un banco vÃ¡lido.');
}

$posiblesMontos = [
    'monto_efectivoPurchase',
    'importe_transferenciaPurchase',
