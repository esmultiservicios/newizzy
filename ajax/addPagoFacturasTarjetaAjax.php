...
$importeTarjeta = valorNumericoPago('importe_tarjeta');
...
normalizarPostNumericoPago([
    ...
    'customer_bill_pay',
    'monto_efectivo',
    'monto_efectivo_tarjeta',
    'importe_tarjeta'
]);

$_POST['monto_efectivo'] = number_format($montoAplicado, 2, '.', '');
$_POST['importe_tarjeta'] = number_format($importeTarjeta, 2, '.', '');

if (isset($_POST['monto_efectivo_tarjeta'])) {
    $_POST['monto_efectivo_tarjeta'] = $_POST['monto_efectivo'];
}
