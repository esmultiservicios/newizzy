<script>
    ...
    var listar_registro_cajas = function () {
        ...
        var table_registro_cajas = $("#dataTableCajas").DataTable({
            ...
            "columns": [{
                    "defaultContent": "<button class='table_crear btn btn-success'><span class='fas fa-times-circle fa-lg'></span></button>"
                },
                {
                    "defaultContent": "<button class='table_reportes table_eliminar btn btn-danger'><span class='far fa-file-pdf fa-lg'></span></button>"
                },
                {
                    "data": "fecha"
                },
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        if (type === 'display') {
                            var icon = data === 'Activa' ?
                                '<i class="fas fa-check-circle mr-1"></i>' :
                                '<i class="fas fa-times-circle mr-1"></i>';
                            var badgeClass = data === 'Activa' ?
