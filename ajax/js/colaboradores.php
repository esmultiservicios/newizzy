...
$(document).ready(function() {
    window.izzySoloSelect2($('#form_main_colaboradores select, #formColaboradores select'));
...
function editar_colaborador_ui(data) {
    ...
    $.ajax({
        ...
        success: function(registro) {
            ...
            window.izzySoloRefreshSelect2($('#formColaboradores #puesto_colaborador'));

            $('#formColaboradores #colaborador_empresa_id').val(valores[4]);
            window.izzySoloRefreshSelect2($('#formColaboradores #colaborador_empresa_id'));
