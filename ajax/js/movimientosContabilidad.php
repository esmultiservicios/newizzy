...
function movimientosReportMoney(value){
    return 'L. ' + movimientosNumero(value).toLocaleString('es-HN',{minimumFractionDigits:2,maximumFractionDigits:2});
}
...
function movimientosExcelCell(ref,v,style,numeric){if(numeric){var n=movimientosNumero(v);return '<c r="'+ref+'" s="'+style+'"><v>'+n+'</v></c>';}return '<c r="'+ref+'" s="'+style+'" t="inlineStr"><is><t>'+movimientosExcelEscape(v)+'</t></is></c>';}
...
function movimientosExportarExcel(){
    ...
    sheetRows.push('<row r="3">'+movimientosExcelCell('A3','Ingresos: '+movimientosReportMoney(resumen.ingresos)+' | Egresos: '+movimientosReportMoney(resumen.egresos)+' | Balance: '+movimientosReportMoney(resumen.balance)+' | Saldo final: '+movimientosReportMoney(resumen.saldoFinal),2)+'</row>');
    ...
    rows.forEach(function(r,i){var rr=6+i;var vals=[r.fecha,r.codigo,r.nombre,movimientosTipo(r),movimientosNumero(r.ingreso),movimientosNumero(r.egreso),movimientosNumero(r.saldo)];sheetRows.push('<row r="'+rr+'">'+vals.map(function(v,c){var money=c>=4&&c<=6;return movimientosExcelCell(movimientosExcelCol(c)+rr,v,money?6:4,money);}).join('')+'</row>');});
    var totalRow=6+rows.length;
    sheetRows.push('<row r="'+totalRow+'">'+movimientosExcelCell('A'+totalRow,'TOTALES',5,false)+movimientosExcelCell('B'+totalRow,'',5,false)+movimientosExcelCell('C'+totalRow,'',5,false)+movimientosExcelCell('D'+totalRow,'',5,false)+movimientosExcelCell('E'+totalRow,resumen.ingresos,7,true)+movimientosExcelCell('F'+totalRow,resumen.egresos,7,true)+movimientosExcelCell('G'+totalRow,resumen.saldoFinal,7,true)+'</row>');
    var sheetXml='<'+'?xml version="1.0" encoding="UTF-8" standalone="yes"?>'+'<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><dimension ref="A1:G'+totalRow+'"/><sheetViews><sheetView workbookViewId="0" showGridLines="0"><pane ySplit="5" topLeftCell="A6" activePane="bottomLeft" state="frozen"/></sheetView></sheetViews><cols><col min="1" max="1" width="16" customWidth="1"/><col min="2" max="2" width="15" customWidth="1"/><col min="3" max="3" width="30" customWidth="1"/><col min="4" max="4" width="18" customWidth="1"/><col min="5" max="7" width="20" customWidth="1"/></cols><sheetData>'+sheetRows.join('')+'</sheetData><autoFilter ref="A5:G'+(totalRow-1)+'"/><mergeCells count="3"><mergeCell ref="A1:G1"/><mergeCell ref="A2:G2"/><mergeCell ref="A3:G3"/></mergeCells></worksheet>';
    var stylesXml='<'+'?xml version="1.0" encoding="UTF-8" standalone="yes"?>'+'<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><numFmts count="1"><numFmt numFmtId="164" formatCode="&quot;L. &quot;#,##0.00"/></numFmts><fonts count="6"><font><sz val="10"/><name val="Calibri"/></font><font><b/><sz val="16"/><color rgb="FFFFFFFF"/><name val="Calibri"/></font><font><sz val="9"/><color rgb="FF5E6C84"/><name val="Calibri"/></font><font><b/><sz val="10"/><color rgb="FFFFFFFF"/><name val="Calibri"/></font><font><sz val="10"/><color rgb="FF172B4D"/><name val="Calibri"/></font><font><b/><sz val="10"/><color rgb="FF17324D"/><name val="Calibri"/></font></fonts><fills count="5"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill><fill><patternFill patternType="solid"><fgColor rgb="FF17324D"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FF0EA5A8"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FFEAF1F7"/></patternFill></fill></fills><borders count="2"><border><left/><right/><top/><bottom/><diagonal/></border><border><left style="thin"><color rgb="FFDDE3EA"/></left><right style="thin"><color rgb="FFDDE3EA"/></right><top style="thin"><color rgb="FFDDE3EA"/></top><bottom style="thin"><color rgb="FFDDE3EA"/></bottom><diagonal/></border></borders><cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/></cellStyleXfs><cellXfs count="8"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/><xf numFmtId="0" fontId="1" fillId="2" borderId="0" xfId="0"/><xf numFmtId="0" fontId="2" fillId="0" borderId="0" xfId="0"/><xf numFmtId="0" fontId="3" fillId="3" borderId="1" xfId="0" applyAlignment="1"><alignment horizontal="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="1" xfId="0" applyAlignment="1"><alignment wrapText="1"/></xf><xf numFmtId="0" fontId="5" fillId="4" borderId="1" xfId="0" applyAlignment="1"><alignment wrapText="1"/></xf><xf numFmtId="164" fontId="4" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="right"/></xf><xf numFmtId="164" fontId="5" fillId="4" borderId="1" xfId="0" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="right"/></xf></cellXfs><cellStyles count="1"><cellStyle name="Normal" xfId="0" builtinId="0"/></cellStyles></styleSheet>';
    ...
    var zip=new JSZip();zip.file('[Content_Types].xml',contentTypes);zip.folder('_rels').file('.rels',rootRels);zip.folder('xl').file('workbook.xml',workbookXml);zip.folder('xl').file('styles.xml',(window.izzyExcelBordesEstilos ? window.izzyExcelBordesEstilos(stylesXml) : stylesXml));zip.folder('xl').folder('_rels').file('workbook.xml.rels',workbookRels);zip.folder('xl').folder('worksheets').file('sheet1.xml',(window.izzyExcelBordesHoja ? window.izzyExcelBordesHoja(sheetXml) : sheetXml));
...
function movimientosExportarPdf(){
    ...
    movimientosObtenerLogoPdf(function(logo){
        ...
        rows.forEach(function(r,i){var fill=i%2===0?'#FFFFFF':'#F7F9FC',saldo=movimientosNumero(r.saldo);body.push([
            ...
            {text:movimientosReportMoney(r.ingreso),style:'tdn',fillColor:fill,color:'#14804A'},{text:movimientosReportMoney(r.egreso),style:'tdn',fillColor:fill,color:'#C9372C'},{text:movimientosReportMoney(r.saldo),style:'tdn',fillColor:fill,color:saldo<0?'#C9372C':saldo>0?'#14804A':'#253858'}
        ]);});
        body.push([{text:'TOTALES',colSpan:4,style:'totalLabel',fillColor:'#EAF1F7'},{},{},{},{text:movimientosReportMoney(resumen.ingresos),style:'totalSuccess',fillColor:'#EAF1F7'},{text:movimientosReportMoney(resumen.egresos),style:'totalDanger',fillColor:'#EAF1F7'},{text:movimientosReportMoney(resumen.saldoFinal),style:'totalCurrent',fillColor:'#EAF1F7'}]);
        ...
        var kpis={table:{widths:['*','*','*','*'],body:[[
            {stack:[{text:'INGRESOS',fontSize:6.2,bold:true,color:'#6B778C'},{text:movimientosReportMoney(resumen.ingresos),fontSize:11,bold:true,color:'#14804A',margin:[0,2,0,0]}],fillColor:'#F7F9FC',margin:[8,7,8,7]},
            {stack:[{text:'EGRESOS',fontSize:6.2,bold:true,color:'#6B778C'},{text:movimientosReportMoney(resumen.egresos),fontSize:11,bold:true,color:'#C9372C',margin:[0,2,0,0]}],fillColor:'#F7F9FC',margin:[8,7,8,7]},
            {stack:[{text:'BALANCE',fontSize:6.2,bold:true,color:'#6B778C'},{text:movimientosReportMoney(resumen.balance),fontSize:11,bold:true,color:'#17324D',margin:[0,2,0,0]}],fillColor:'#F7F9FC',margin:[8,7,8,7]},
            {stack:[{text:'SALDO FINAL',fontSize:6.2,bold:true,color:'#6B778C'},{text:movimientosReportMoney(resumen.saldoFinal),fontSize:11,bold:true,color:'#6554C0',margin:[0,2,0,0]}],fillColor:'#F7F9FC',margin:[8,7,8,7]}
