                ...
                if($tamano_tabla >0){
                    ...
                    if($tipoPurchase == 1){		
                        ...
                        if($query){
                            ...
                            $saldo_cero = comprasModelo::verificar_saldo_cero($compras_id);
                            
                            if($saldo_cero) {
                                // Actualizar estado a pago completo
                                comprasModelo::actualizar_estado_pago_completo($compras_id);
                                
                                // Cambiar la función para imprimir el comprobante
                                $alert['funcion'] = str_replace("pagoCompras", "printPurchase", $alert['funcion']);
                                $alert['funcion'] .= " showNotification('Pago completado', 'La compra ha sido pagada en su totalidad', 'success');";
                            }
