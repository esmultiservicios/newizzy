    ...
    try {
        ...
        foreach ($basesSincronizadas as $dbClienteNotificar) {
            $svc->notifyAdmins(
                $dbClienteNotificar,
                0,
                'IZZY · Nuevo plan disponible',
                'Se creó y sincronizó un nuevo plan disponible para este cliente.',
                $detallePlan,
                [],
                'billing'
            );
        ...
        $svc->notifyAdmins(
            ...
            0,
            'IZZY · Plan creado',
            'Se creó un nuevo plan en el catálogo principal y se sincronizó con las bases de clientes disponibles.',
            $detallePlan + [
        ...
        error_log('Planes - notificación creación: ' . $e->getMessage());
    }
