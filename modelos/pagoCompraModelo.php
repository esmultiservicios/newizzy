<?php
    ...
    class pagoCompraModelo extends mainModel{
        // Método principal para agregar pagos de compras, simplificado y dividido en métodos más pequeños
        ...
        protected function procesarPagoCredito($res) {
            ...
            if ($saldoCredito === false) {
                return $this->crearAlertaError("No se pudo obtener información de la cuenta por pagar");
            }

            // Validar que no se hagan más abonos que el importe
            ...
            // Validar si es pago múltiple y aún hay saldo
            $saldoNuevo = $this->obtenerSaldoActualizado($res['compras_id']);
            
            if ($res['multiple_pago'] == 1 && $saldoNuevo > 0) {
                return $this->crearAlertaMultiple($res);
            } else {
                return $this->crearAlertaSimple($res);
            }
        }
        ...
        protected function agregarPagoCompra($res) {
            ...
            return $this->agregar_pago_compras_modelo($datos);
        }
        ...
        protected function crearAlertaMultiple($res) {
            return [
        ...
        protected function crearAlertaSimple($res) {
            return [
                "title" => "Registro almacenado",
                "text" => "El registro se ha almacenado correctamente",
                "type" => "success",
        ...
        // Métodos que interactúan con la base de datos (mantenidos del original)
