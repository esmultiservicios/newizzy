...
class productosModelo extends mainModel{
    protected function agregar_productos_modelo($datos){
        ...
        $insert = "INSERT INTO productos 
            ...
            tipo_producto_id, precio_compra, porcentaje_venta, precio_venta, cantidad_mayoreo, precio_mayoreo,
            cantidad_minima, cantidad_maxima, estado, isv_venta, isv_compra, colaborador_id,
            file_name, empresa_id, fecha_registro, id_producto_superior, restaurante, isv1, isv2)
            VALUES(
            '$productos_id','".$datos['bar_code_product']."','".$datos['almacen_id']."',
            ...
            '".$datos['id_producto_superior']."','".$datos['restaurante']."','".$datos['isv1']."','".$datos['isv2']."')";
