  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        ...
        <form class="FormularioAjax" id="formSecuencia" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="form-row">
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <select id="empresa_secuencia" name="empresa_secuencia"
                          class="selectpicker"
                          data-live-search="true"
                          data-width="100%"
                          data-container="#modal_registrar_secuencias"
                          title="Seleccione una empresa" required>
                    <option value="">Seleccione</option>
                  </select>
                  <small class="form-text text-muted d-none d-sm-block">Empresa asociada a esta secuencia</small>
                </div>

                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  <label for="documento_secuencia"><i class="fas fa-file-alt mr-1"></i>Documento <span class="priority">*</span></label>
                  <select id="documento_secuencia" name="documento_secuencia"
                          class="selectpicker"
                          data-live-search="true"
                          data-width="100%"
                          data-container="#modal_registrar_secuencias"
                          title="Seleccione un documento" required>
                    <option value="">Seleccione</option>
                  </select>
                  <small class="form-text text-muted d-none d-sm-block">Tipo de documento a secuenciar</small>
                </div>
                ...
                <div class="col-12 col-lg-6 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Código de Autorización de Impresión (37 caracteres)</small>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="form-row">
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Texto inicial del número de documento</small>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Cantidad de dígitos para el número</small>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Valor de incremento para cada documento</small>
                </div>

                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  <label for="siguiente_secuencia"><i class="fas fa-arrow-right mr-1"></i>Siguiente <span class="priority">*</span></label>
                  <input type="number" name="siguiente_secuencia" id="siguiente_secuencia" class="form-control" placeholder="Siguiente" required>
                  <small class="form-text text-muted d-none d-sm-block">Próximo número a utilizar</small>
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Primer número autorizado</small>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Último número autorizado</small>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Fecha de inicio de uso</small>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3">
                  ...
                  <small class="form-text text-muted d-none d-sm-block">Fecha máxima de uso</small>
                </div>
              </div>
          ...
          <div class="card border-primary mb-4" id="estado_secuencia_container">
            ...
            <div class="card-body">
              ...
              <small class="form-text text-muted d-none d-sm-block">Active o desactive esta secuencia en el sistema</small>
            </div>
          </div>
      ...
      <div class="modal-footer">
        <button class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times fa-lg mr-1"></i> Cancelar</button>
